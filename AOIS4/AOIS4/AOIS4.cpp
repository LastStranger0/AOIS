...
int main()
{
	...
	cout << "P СДНФ: " << sdnf_Di << endl;
	cout << "S СДНФ: " << sdnf_Bi1 << endl;

	cout << endl << "P в ТДФ: " << dead_end(glued(sdnf_Di)) << endl;
	cout << "S в ТДФ: " << dead_end(glued(sdnf_Bi1)) << endl << endl;
	...
	cout << "Всего транзисторов: " << total << endl;


	cout << endl << endl << "Задание 2 (в):" << endl;
	vector <table> tbl = to_table(4);
	print_tabl(tbl);
	minimized(tbl);
...
void print_tabl(vector<table> out)
{
...
void minimized(vector <table> tbl)
{
	...
	cout << "СДНФ y1: " << out[0] << endl;
	cout << "СДНФ y2: " << out[1] << endl;
	cout << "СДНФ y3: " << out[2] << endl;
	cout << "СДНФ y4: " << out[3] << endl;
